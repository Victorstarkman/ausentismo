        ...
        for($i=0;$i<$numList;$i++){
             if(!empty($patientsList[$i]['reports'] )){ 
                ...
                for($j=0;$j<$count_reports;$j++){
                    ...
                    isset($patientsList[$i]['reports'][$j]['specialty']->name)?$activeSheet->setCellValue('H'.$fila,$patientsList[$i]['reports'][$j]['specialty']->name):$activeSheet->setCellValue('H'.$fila,'');
                    ...
                    $activeSheet->setCellValue('L'.$fila,$patientsList[$i]['reports'][$j]['askedDays']);
                    $activeSheet->setCellValue('M'.$fila,$patientsList[$i]['reports'][$j]['recommendedDays']);
                    $dictamen=isset($patientsList[$i]['reports'][$j]['cie10'])?$patientsList[$i]['reports'][$j]['cie10']->name:'No especificado';
                    $activeSheet->setCellValue('N'.$fila,$patientsList[$i]['reports'][$j]['doctor']->name.' '.$patientsList[$i]['reports'][$j]['doctor']->lastname);
                    $activeSheet->setCellValue('O'.$fila,$dictamen);
                    $codeCie10=isset($patientsList[$i]['reports'][$j]['cie10'])?$patientsList[$i]['reports'][$j]['cie10']->code:'No especificado';
